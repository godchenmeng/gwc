...
public class GMailEngine extends ListImageCaptchaEngine {
    ...
    protected void buildInitialFactories() {
        ...
        TextPaster randomPaster = new DecoratedRandomTextPaster(minWordLength,
                ...
                new Color(23, 67, 172),new Color(220, 34, 200)}), new TextDecorator[]{});
        BackgroundGenerator background = new UniColorBackgroundGenerator(
                imageWidth, imageHeight, Color.white);
        FontGenerator font = new RandomFontGenerator(fontSize, fontSize,
                new Font[]{new Font("Arial", Font.BOLD, fontSize),
                        new Font("宋体", Font.BOLD, fontSize),
                        new Font("TimesRoman", Font.BOLD, fontSize),new Font("华文新魏", Font.BOLD, fontSize)});
