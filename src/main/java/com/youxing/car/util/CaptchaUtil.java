...
public class CaptchaUtil {
    // 随机产生的字符串
    private static final String RANDOM_STRS = "023456789abcdefghijklmnopqrstuvwxyz";
    ...
    /**
     * 往response中写验证码图片，并返回验证码字符串
     * @param resp
     * @return
     */
    public static String writeRespImg(HttpServletResponse resp,String uid) {
        CaptchaUtil tool = new CaptchaUtil();
        StringBuffer code = new StringBuffer();
        BufferedImage image = tool.genRandomCodeImage(code);
        OutputStream fos = null;
        try {
        	resp.setHeader("authentication", uid);
