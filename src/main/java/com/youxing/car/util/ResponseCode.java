...
public enum ResponseCode {
    ...
    verify_captcha_error(20004, "验证码错误,请刷新验证码!"),
    ...
    user_already_exist(30007, "用户不匹配"),
    no_org(30008, "该用户没有机构"),
    token_error(30010, "token验证失败请重新获取"),
    no_device(30011, "车辆未绑定设备"),
    un_end(30012, "有尚未完成的任务"),
    task_already_exit(30013,"驾驶任务已经存在"),
    repeat_operate(30014,"不能重复操作"),
    no_obd(30015,"没有绑定设备"),
    parameter_length(30009, "参数长度不匹配"),
    user_upload_error(30016, "上传失败"),
    login_name_null(30017,"登录名为空"),
    login_error(30018,"此账号在其他地方登录，你已被强制下线");
